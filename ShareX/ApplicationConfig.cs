...
namespace ShareX
{
    public class ApplicationConfig : SettingsBase<ApplicationConfig>
    {
        ...
        /// <summary>Intervalo en segundos entre fotogramas del timelapse (por defecto 5).</summary>
        public int TimelapseIntervalSeconds { get; set; } = 5;

        /// <summary>Porcentaje mínimo de cambio de pantalla para CaptureOnChange (0-100).</summary>
        public float CaptureOnChangeThresholdPercent { get; set; } = 5f;

        /// <summary>Habilitar monitoreo del portapapeles en tiempo real.</summary>
